...
def get_args_parser():
    ...
    parser.add_argument('--fusion-strategy', default='no', type=str, help='')
    parser.add_argument('--fusion-layer', default=11, type=int, help='')
    parser.add_argument('--fusion-token', default=7, type=int, help='')

    parser.add_argument('--visualize', action='store_true', default=False, help='')
    parser.add_argument('--bi-merge', action='store_true', default=False, help='')
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'CIFAR10', 'IMNET', 'INAT', 'INAT19', 'TINYIMAGENET'],
...
def main(args):
    ...
    model = create_model(
        ...
        fusion_token=args.fusion_token,
        visualize=args.visualize,
        bi_merge=args.bi_merge,
    )
