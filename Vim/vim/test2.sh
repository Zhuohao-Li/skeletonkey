...
#     --finetune ./output/vim_t_midclstok_ft_78p3acc.pth \
#     --epochs 30 \
#     --no_amp
...
# eval vim tiny, imaganet-1k
CUDA_VISIBLE_DEVICES=7 python main.py --eval \
    --resume ./output/vim_t_midclstok_ft_78p3acc.pth \
    --model vim_tiny_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2 \
    --data-path ./imagenet-1k/data \
    --data-set IMNET 